      ...
      switch ($direction) {
        case "G" :
          if ($coordonnéesC[0] - ($nbrCases * 2) >= 1) {
            ...
            echo "entrer un nouvelle direction (G, D, H ou B)".PHP_EOL;
            break;
          }
        case "D" :
...
while ($i < 5) {
  ...
  switch ($placement[0]) {
    ...
    $coord[$coordonnéesL[0]][$coordonnéesC[0]] = "B";
    //On choisi le sens du bateau
    $false = 1;
    while(true){
      $direction = array("G", "D", "H", "B");
      $direct = array_rand($direction, 1);
      switch ($direction) {
        case "G" :
          if ($coordonnéesC[0] - ($nbrCases * 2) >= 24) {
            $coord[$coordonnéesL[0]][$coordonnéesC[0]-(2)] = "B";
            if ($nbrCases > 1) {
              $coord[$coordonnéesL[0]][$coordonnéesC[0]-(4)] = "B";
            }
            if ($nbrCases > 3) {
              $coord[$coordonnéesL[0]][$coordonnéesC[0]-(6)] = "B";
            }
            if ($nbrCases > 4) {
              $coord[$coordonnéesL[0]][$coordonnéesC[0]-(8)] = "B";
            }
            $false = 0;
            break;
          } else {
        ...
        case "D" :
          if ($coordonnéesC[0] + ($nbrCases * 2) <= 44) {
            $coord[$coordonnéesL[0]][$coordonnéesC[0]+(2)] = "B";
            if ($nbrCases > 1) {
              $coord[$coordonnéesL[0]][$coordonnéesC[0]+(4)] = "B";
            }
        ...
        case "H" :
          if ($coordonnéesL[0] - $nbrCases >= 2) {
            $coord[$coordonnéesL[0]-1][$coordonnéesC[0]] = "B";
            if ($nbrCases > 1) {
              $coord[$coordonnéesL[0]-2][$coordonnéesC[0]] = "B";
            }
            if ($nbrCases > 3) {
              $coord[$coordonnéesL[0]-3][$coordonnéesC[0]] = "B";
            }
            if ($nbrCases > 4) {
              $coord[$coordonnéesL[0]-4][$coordonnéesC[0]] = "B";
            }
            $false = 0;
            break;
          } else {
...
while($u<18){
  ...
  elseif($coord[$coordonnéesL[0]][$coordonnéesC[0]] == "*") {
