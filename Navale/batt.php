...
for($i = 0, $nbrCases = 0; $i < 5; $i++){
  $nbrCases ++;
  echo "Placez le $listeBateaux[$i]. Entrez une coordonnée de départ (Lettre/Chiffre) (O pour 10): ".PHP_EOL;
  coordonnee($coord, $nbrCases);
  $i++;
  while(true){
    $nbrCases ++;
    echo "Placez le $listeBateaux[$i]. Entrez une coordonnée de départ (Lettre/Chiffre) (0 pour 10): ".PHP_EOL;
    coordonnee($coord, $nbrCases);
    if($i == 4){
      break;
    }
...
function coordonnee($coord, $nbrCases){
